package com.cognizant.week2.jpa.handson08;
...
public class UpdateCountryApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(UpdateCountryApplication.class, args);
    }
    ...
    CommandLineRunner demo(CountryService countryService) {
        return args -> {
            ...
            System.out.println(countryService.findByCode("IN").getCountryName());
        };
    }
}
